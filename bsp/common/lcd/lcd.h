...
#include "mipi_dbi/spd2010_dbi_qspi.h"
#define LCD_INTERFACE_TYPE           LCD_INTERFACE_DBI
#define LCD_W                        SPD2010_DBI_W
#define LCD_H                        SPD2010_DBI_H
#define LCD_PIXEL_ALIGN_X            SPD2010_DBI_PIXEL_ALIGN
#define LCD_PIXEL_ALIGN_Y            SPD2010_DBI_PIXEL_ALIGN
#define LCD_COLOR_DEPTH              SPD2010_DBI_COLOR_DEPTH
#define _LCD_FUNC_DEFINE(_func, ...) spd2010_dbi_##_func(__VA_ARGS__)
