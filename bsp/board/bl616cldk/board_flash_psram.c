...
flash_clock_para_t flash_clock_para_list[] = {
    ...
    [24].flash_clock = GLB_SFLASH_CLK_MUXPLL_80M,
...
static int ATTR_TCM_SECTION clk_pll_set(uint32_t sdmin)
{
    ...
    regval = BL_RD_WORD(GLB_BASE + GLB_WIFIPLL_SDMIN_OFFSET);
    regval = regval & GLB_WIFIPLL_SDM_IN_UMSK;
    regval = regval | sdmin;
    BL_WR_WORD(GLB_BASE + GLB_WIFIPLL_SDMIN_OFFSET, regval);
    ...
    regval = BL_RD_WORD(GLB_BASE + GLB_WIFIPLL_ANA_CTRL_OFFSET);
    regval = BL_SET_REG_BITS_VAL(regval, GLB_WIFIPLL_VCO_SPEED, vco_speed_bit);
    ...
    BL_WR_WORD(GLB_BASE + GLB_WIFIPLL_ANA_CTRL_OFFSET, regval);
    ...
    regval = BL_RD_WORD(GLB_BASE + GLB_WIFIPLL_TEST_AND_READBACK_OFFSET);
...
static int ATTR_TCM_SECTION board_get_flash_delay(spi_flash_cfg_type *p_flash_cfg)
{
    ...
    regval = BL_RD_WORD(GLB_BASE + GLB_WIFIPLL_SDMIN_OFFSET);
    pre_sdmin = regval & GLB_WIFIPLL_SDM_IN_MSK;
